<x-guest-layout>
    <div class="text-center mb-6">
        <h2 class="text-2xl font-heading font-bold text-slate-900">Create an Account</h2>
        <p class="text-sm text-slate-500 mt-2">Join EasyColoc and find your perfect roommate.</p>
    </div>
